...
[TweakAuthor("Karou")]
[TweakDescription("Enables Shift on numpad.")]
[TweakAutoConfig]
public partial class KeyInterruptPlus : SecretTweaks.SubTweak {
    ...
    private nint OnKeystroke(int nCode, nint wParam, ref KeyInfoStruct lParam) {
        ...
        {
            case 0x52:
                SendMessageW(handle, lParam.flags == KeyInfoFlags.LLKHF_UP ? WM_KEYUP : WM_KEYDOWN, (int)VirtualKey.NUMPAD0, 0);
                break;
            case 0x4F:
                SendMessageW(handle, lParam.flags == KeyInfoFlags.LLKHF_UP ? WM_KEYUP : WM_KEYDOWN, (int)VirtualKey.NUMPAD1, 0);
                break;
            case 0x50:
                SendMessageW(handle, lParam.flags == KeyInfoFlags.LLKHF_UP ? WM_KEYUP : WM_KEYDOWN, (int)VirtualKey.NUMPAD2, 0);
                break;
            case 0x51:
                SendMessageW(handle, lParam.flags == KeyInfoFlags.LLKHF_UP ? WM_KEYUP : WM_KEYDOWN, (int)VirtualKey.NUMPAD3, 0);
                break;
            case 0x4B:
                SendMessageW(handle, lParam.flags == KeyInfoFlags.LLKHF_UP ? WM_KEYUP : WM_KEYDOWN, (int)VirtualKey.NUMPAD4, 0);
                break;
            case 0x4C:
                SendMessageW(handle, lParam.flags == KeyInfoFlags.LLKHF_UP ? WM_KEYUP : WM_KEYDOWN, (int)VirtualKey.NUMPAD5, 0);
                break;
            case 0x4D:
                SendMessageW(handle, lParam.flags == KeyInfoFlags.LLKHF_UP ? WM_KEYUP : WM_KEYDOWN, (int)VirtualKey.NUMPAD6, 0);
                break;
            case 0x47:
                SendMessageW(handle, lParam.flags == KeyInfoFlags.LLKHF_UP ? WM_KEYUP : WM_KEYDOWN, (int)VirtualKey.NUMPAD7, 0);
                break;
            case 0x48:
                SendMessageW(handle, lParam.flags == KeyInfoFlags.LLKHF_UP ? WM_KEYUP : WM_KEYDOWN, (int)VirtualKey.NUMPAD8, 0);
                break;
            case 0x49:
                SendMessageW(handle, lParam.flags == KeyInfoFlags.LLKHF_UP ? WM_KEYUP : WM_KEYDOWN, (int)VirtualKey.NUMPAD9, 0);
                break;
            case 0x53:
                SendMessageW(handle, lParam.flags == KeyInfoFlags.LLKHF_UP ? WM_KEYUP : WM_KEYDOWN, (int)VirtualKey.DECIMAL, 0);
                break;
        }
        return 1;
